...
function PowerButtons(operations) {
  ...
  return Widget.Box({
    ...
    vertical: hyprland.active.bind("monitor").as((monitorId) => {
    ...
    children: [
      CreateButton(
        ...
        operations.shutdown.command,
      ),
      CreateButton(
        "Logout",
        "system-log-out-symbolic",
        operations.logout.command,
      ),
      CreateButton(
        "Reboot",
        "system-reboot-symbolic",
        operations.reboot.command,
      ),
      CreateButton(
        "Suspend",
        "system-suspend-symbolic",
        operations.sleep.command,
      ),
      CreateButton(
        "Lock",
        "system-lock-screen-symbolic",
        operations.lock.command,
      ),
    ],
  });
}
